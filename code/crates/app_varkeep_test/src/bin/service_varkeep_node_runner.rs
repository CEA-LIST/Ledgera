...
use ledgera_app_varkeep::service_client_logic::service_client_state::LedgeraServiceClientState;
use ledgera_app_varkeep_tui::setup::ledgera_service_tui_setup;
...
use ledgera_app_varkeep_tui::setup::ledgera_tui_log_setup;
...
async fn main() {
    ...
    let service = Arc::new(LedgeraVarkeepService);
    ...
    match ledgera_node_state.run().await {
        ...
        Some(core_client_run) => {
            ...
            let service_node_runtime_io = service_node_state
                ...
                .await
                .unwrap();
            ledgera_service_tui_setup(node_name, service_node_runtime_io).await;
        }
    }
}
